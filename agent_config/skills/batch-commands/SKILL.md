...
## Usage Guidelines
* **Omit the Binary Prefix:** Inside the `cat` block, do not include the `/bin/narsil_client.py` prefix. Write only the subcommand name (e.g., `symbol`, `refs`, `excerpt`) and its flags.
